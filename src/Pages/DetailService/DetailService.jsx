...
const DetailService = () => {
  ...
  // Verificar si serviceDetails.rows existe y tiene al menos un elemento
  ...
  // Obtener el primer elemento de serviceDetails.rows (asumiendo que solo se espera un servicio)
